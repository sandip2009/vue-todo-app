<template>
    <div class="p-6 max-w-lg mx-auto">
        ...
        <div class="flex mb-4 justify-end items-end">
            <button @click="reset()" class="text-red-600 float-end">
                reset
            </button>
        </div>
                    ...
                    >
                        ...
                        <td class="px-6 py-4">
                            <button
                                ...
                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-2.5"
                            >
                                Edit
                            </button>
                            <button
...
export default {
    ...
    methods: {
        ...
        async addTodo() {
            ...
            let res = await this.axios.post("/api/todos", {
                title: this.newTodo,
            });
        ...
        async editTodo() {
            if (!this.newTodo) return;
            let res = await this.axios.patch(`/api/todos/${this.id}`, {
                title: this.newTodo,
            });
